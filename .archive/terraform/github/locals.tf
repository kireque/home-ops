locals {
  ...
  kireque_bot_secrets = {
    "KIREQUE_APP_ID"          = module.onepassword_item_github_kireque_bot.fields.github_app_id
    "KIREQUE_APP_PRIVATE_KEY" = module.onepassword_item_github_kireque_bot.fields.github_app_private_key
  }
}
